...
const GameLayout = memo(function GameLayout({ children, title }) {
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center justify-center p-4 select-none z-10 overflow-y-auto overflow-x-hidden no-scrollbar">
